    ...
    <>
      ...
      <header className="sticky top-0 z-10 flex items-center justify-between border-b border-gray-200 bg-white px-16 py-8">
        ...
        >
          ...
          <button onClick={() => {
            router.push('/login')
          }} className="text-gray-800 hover:font-bold hover:text-black cursor-pointer"> Login</button>


          {/* Sign Up Dropdown - Click to open */}
          <div className="relative" ref={signupRef}>
            <button
              onClick={() => setIsSignupOpen(!isSignupOpen)}
              className="flex items-center space-x-1 text-gray-800 hover:font-bold hover:text-black focus:outline-none cursor-pointer"
            >
              <span>Sign Up</span>
            ...
            {isSignupOpen && (
              <div
                className="absolute right-1 mt-2 w-58 flex-col rounded-md border border-gray-200 bg-white text-gray-800 shadow-lg"
                style={{ zIndex: 50 }}
              >
                <a
                  href="/signup?role=Company"
                  className="block px-4 py-2 hover:bg-gray-100 hover:font-semibold"
                ...
                <a
                  href="/signup?role=GovernmentBody"
                  className="block px-4 py-2 hover:bg-gray-100 hover:font-semibold"
                  onClick={() => setIsSignupOpen(false)}
                >
                  Sign up as Government
                </a>
        ...
        {isMobileNavOpen && (
          ...
          >
            ...
            <a href="/login" onClick={() => setMobileNavOpen(false)} className="text-black hover:font-semibold">
              Login
            </a>
            <div className="relative">
              <button
                onClick={() => setIsSignupOpen(!isSignupOpen)}
                className="flex items-center space-x-1 text-black hover:font-semibold hover:text-black focus:outline-none cursor-pointer"
              >
                <span>Sign Up</span>
                <ChevronDown className="w-4 h-4" />
              </button>
              {isSignupOpen && (
                <div
                  className="absolute left-1/2 top-full mt-2 w-64 -translate-x-1/2 flex-col rounded-md border border-gray-200 bg-white text-gray-800 shadow-lg"
                  style={{ zIndex: 50 }}
                >
                  <a
                    href="/signup?role=Company"
